...
# Booking.com - Web - Lesson 2 - Practical Exercise

This repository contains the solution to the Practical Exercise from Lesson 2, written in NightwatchJS.
...
```sh
git clone https://github.com/Manual-To-Automation-Booking/Lesson-2-Exercise.git
```
